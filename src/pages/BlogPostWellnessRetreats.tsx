...
import { wellnessRetreatsData } from '@/data/articles/wellnessRetreatsData';
import { Link } from 'react-router-dom';

const BlogPostWellnessRetreats = () => {
  return (
    <BlogPostLayout
      title={wellnessRetreatsData.seo.title}
      description={wellnessRetreatsData.seo.description}
      heroProps={wellnessRetreatsData.hero}
      relatedLinks={wellnessRetreatsData.relatedLinks}
      ctaProps={wellnessRetreatsData.cta}
    >
      <BlogPostIntro>
