    ...
    <>
      ...
      <main className="container mx-auto px-4 py-16 flex-1">
        <section className="max-w-4xl mx-auto text-center">
          <h1 className="text-4xl font-bold mb-6 text-brand-dark">Join Our Wellness Community</h1>
          <p className="text-xl mb-8 text-brand-dark/80">
          ...
          <div className="bg-brand-light p-8 rounded-lg mb-12 border border-brand-sand/20 shadow-sm">
            <h2 className="text-2xl font-semibold mb-4 text-brand-dark">Member Benefits</h2>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Button asChild size="lg" variant="outline" className="border-brand-primary text-brand-primary hover:bg-brand-primary/5">
          ...
          <p className="text-muted-foreground">
            Already a member? <Link to="/login" className="text-brand-primary hover:underline">Sign in here</Link>
          </p>
        </section>
      </main>
      <Footer />
