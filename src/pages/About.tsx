          ...
          <div className="container mx-auto max-w-7xl px-4 md:px-6">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <motion.div
                ...
                className="max-w-3xl"
              >
                <h1 className="text-6xl md:text-7xl font-bold mb-8 text-brand-dark leading-tight">
                ...
                <ul className="space-y-4 mb-8 text-lg">
                  <li className="flex items-start">
                    ...
                    <span>Fast and easy to use mindfulness retreats</span>
                  </li>
                  <li className="flex items-start">
                    <span className="mr-2 text-brand-primary">•</span>
                ...
                <Button 
                  size="lg" 
                  className="bg-brand-primary hover:bg-brand-primary/90 text-white text-lg px-8 py-6 rounded-full"
                >
        ...
        <section className="py-24 bg-white">
          <div className="container mx-auto max-w-6xl px-4 md:px-6">
            ...
            >
              ...
              <h2 className="text-4xl md:text-6xl font-bold mt-4 mb-12 text-brand-dark max-w-5xl mx-auto leading-tight">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              >
                <div className="p-8">
                  ...
                  <Button 
                    variant="outline" 
                    className="border-brand-primary text-brand-primary hover:bg-brand-primary/5 font-medium group"
                  >
                    Learn More
          ...
          <div className="container relative z-10 mx-auto max-w-6xl px-4 md:px-6">
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Button 
                  size="lg" 
                  className="bg-white text-brand-dark hover:bg-white/90 group rounded-full"
                  asChild
                >
                  <a href="/signup">
                    Join as a Member
                ...
                <Button 
                  size="lg" 
                  variant="outline" 
                  className="border-white hover:bg-white/10 text-white group rounded-full"
                  asChild
                >
