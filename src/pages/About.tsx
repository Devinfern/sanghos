        ...
        <section id="hero" className="min-h-[100vh] py-16 md:py-24 px-4 relative overflow-hidden flex items-center">
          ...
          <div className="max-w-7xl mx-auto relative z-10 w-full">
            ...
            >
              <motion.h1 
                variants={fadeIn} 
                className="text-3xl sm:text-4xl md:text-5xl lg:text-7xl mb-6 text-zinc-50 font-bold"
              >
                Give us a day.<br />We'll shift your perspective.
              </motion.h1>
              <motion.p 
                variants={fadeIn} 
                className="text-lg sm:text-xl md:text-2xl text-white/90 leading-relaxed my-[10px] py-[20px]"
              >
          ...
          <div className="max-w-7xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
              {missionCards.map((card, index) => (
                <div 
                  key={index} 
                  className="text-center p-6 sm:p-8 rounded-xl bg-white shadow-sm hover:shadow-md transition-all duration-300"
                >
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4 sm:gap-6">
              {valueCards.map((value, index) => (
                <div 
                  key={index} 
                  className="p-4 sm:p-6 rounded-xl bg-white shadow-sm hover:shadow-md transition-all duration-300 flex flex-col items-center text-center"
                >
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
              {retreatTypeCards.map(type => (
                <div 
                  key={type.id} 
                  className="rounded-xl overflow-hidden shadow-md relative h-[300px] sm:h-[350px] md:h-[400px] group"
                >
                  <OptimizedImage 
                    src={type.image} 
                    alt={type.title} 
