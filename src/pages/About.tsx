...
const About = () => {
  ...
  return <>
      ...
      <main className="bg-white">
        ...
        <section className="min-h-[100vh] py-16 md:py-24 px-4 relative overflow-hidden flex items-center">
        ...
        <section className="py-20 md:py-28 px-4">
          <div className="max-w-7xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12">
              {missionCards.map((card, index) => <div key={index} className="text-center p-8 rounded-xl bg-white shadow-sm hover:shadow-md transition-all duration-300">
        ...
        <section className="py-20 px-4 bg-[#F7F3EE]">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-5 gap-6">
              {valueCards.map((value, index) => <div key={index} className="p-6 rounded-xl bg-white shadow-sm hover:shadow-md transition-all duration-300 flex flex-col items-center text-center">
        ...
        <section className="py-20 px-4">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {retreatTypeCards.slice(0, 3).map(type => <div key={type.id} className="rounded-xl overflow-hidden shadow-md relative h-[400px] group">
