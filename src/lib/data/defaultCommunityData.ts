...
import { ForumCategory, ForumPost, ForumEvent, TrendingPost } from "../types/community";

// Default community data (used until data is loaded from Supabase)
export const defaultForumSpaces: ForumCategory[] = [
  {
    name: "Open Space",
    spaces: [
...
// Default events data
export const defaultForumEvents: ForumEvent[] = [
  {
    id: 1,
...
// Default trending posts data
export const defaultTrendingPosts: TrendingPost[] = [
  {
    id: 1,
