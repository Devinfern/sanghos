...
import { insightInstructors } from './insightInstructors';
import { insightLocations } from './insightLocations';

export const insightRetreatData = [
  {
    ...
    instructor: insightInstructors["instructor-4"],
    date: "2024-07-20",
    time: "9:00 AM",
    duration: "3 days",
    price: 499,
  ...
  },
  {
    ...
    location: insightLocations["insightla-retreat-center"],
    instructor: insightInstructors["instructor-5"],
    date: "2024-08-15",
    time: "10:00 AM",
    duration: "2 days",
    price: 399,
  ...
  },
  {
    ...
    location: insightLocations["online-zoom"],
    instructor: insightInstructors["insight-retreat-center-team"],
    date: "2025-06-21",
    time: "9:00 AM PT",
    duration: "7.5 hours",
    price: 0,
  ...
  },
  {
    ...
    location: insightLocations["trinity-retreat-center"],
    instructor: insightInstructors["trinity-retreat-photography-team"],
    date: "2025-06-14",
    time: "9:00 AM ET",
    duration: "Full day",
    price: 75,
  ...
  },
  {
    ...
    location: insightLocations["nyimc"],
    instructor: insightInstructors["nyimc-meditation-teachers"],
    date: "2025-07-19",
    time: "10:00 AM ET",
    duration: "7 hours",
    price: 50,
  ...
  },
  {
    ...
    location: insightLocations["green-gulch-farm"],
    instructor: insightInstructors["ada-yoga-instructors"],
    date: "2025-08-31",
    time: "9:00 AM PT",
    duration: "8.5 hours",
    price: 180,
  ...
  },
  {
    ...
    location: insightLocations["refuge-recovery-center"],
    instructor: insightInstructors["refuge-recovery-teachers"],
    date: "2025-08-17",
    time: "9:00 AM PT",
    duration: "6 hours",
    price: 50,
  ...
  },
  {
    ...
    location: insightLocations["trinity-retreat-center"],
    instructor: insightInstructors["trinity-movement-teachers"],
    date: "2025-08-09",
    time: "9:00 AM ET",
    duration: "Full day",
    price: 75,
