...
export const insightInstructors: Record<string, Instructor> = {
  "instructor-4": {
    id: "instructor-4",
  ...
  "trinity-retreat-center-team": {
    id: "trinity-retreat-center-team",
    ...
    bio: "Experienced meditation teachers from the Trinity Retreat Center.",
    specialties: ["Mindfulness", "Vipassana", "Online Teaching"],
    yearsExperience: 15
  },
  "trinity-retreat-photography-team": {
