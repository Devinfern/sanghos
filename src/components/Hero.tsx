      ...
      <div className="container relative z-20 px-4 md:px-6 py-24 sm:py-32">
        ...
        >
          ...
          >
            ...
            <motion.p 
              className="text-xl md:text-2xl text-white/95 mb-8 font-light leading-relaxed mt-4 max-w-2xl mx-auto"
              variants={fadeIn}
          ...
          >
            <form onSubmit={handleSearch} className="relative max-w-xl mx-auto mb-10 glass-panel rounded-full overflow-hidden p-1.5 shadow-lg shadow-brand-primary/10 border border-white/20 backdrop-blur-md">
              <div className="flex items-center">
                ...
                <Input 
                  ...
                  className="pl-12 pr-36 py-7 bg-white/80 border-none rounded-full text-foreground placeholder:text-muted-foreground/70 focus:outline-none focus:ring-0" 
                  value={query} 
                ...
                <Button 
                  type="submit" 
                  size="lg" 
                  className="absolute right-1.5 h-12 px-6 rounded-full bg-gradient-to-r from-brand-primary to-brand-primary/90 hover:from-brand-primary/90 hover:to-brand-primary shadow-md hover:shadow-lg transition-all duration-300 hover:scale-[1.03] font-medium"
                >
                  <span>Search</span>
            ...
            <div className="flex flex-col sm:flex-row justify-center space-y-4 sm:space-y-0 sm:space-x-5">
              <Button 
                size="lg" 
                className="group bg-gradient-to-r from-brand-primary to-brand-primary/90 hover:from-brand-primary/90 hover:to-brand-primary shadow-md hover:shadow-lg transition-all duration-300 hover:scale-[1.03] py-6 px-7 text-base rounded-xl" 
              ...
              <Button 
                size="lg" 
                variant="outline" 
                className="bg-white/90 hover:bg-white text-brand-dark border-transparent hover:border-brand-subtle/40 shadow-md hover:shadow-lg transition-all duration-300 hover:scale-[1.03] py-6 px-7 text-base rounded-xl" 
