          ...
          >
            ...
            <div className="p-8">
              ...
              <div className="flex justify-center mb-6">
                <div className="w-16 h-16 bg-gradient-to-br from-brand-primary to-brand-primary/80 rounded-full flex items-center justify-center">
              ...
              <div className="mb-8">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <span className="text-sm font-medium text-brand-slate">Join 10,000+ wellness enthusiasts</span>
                </div>
              ...
              {/* Social Proof */}
              <div className="bg-gradient-to-r from-sage-50 to-brand-subtle/10 rounded-xl p-4 mb-6">
                ...
                <p className="text-xs text-brand-slate/70 mt-1">- Sarah M., Community Member</p>
              </div>

              {/* CTA Buttons */}
              <div className="space-y-3">
                <Link to="/signup" className="block w-full">
                  <Button className="w-full bg-brand-primary hover:bg-brand-primary/90 text-white font-medium py-3">
                    Create Free Account
                  </Button>
                </Link>
              ...
              {/* Fine Print */}
              <p className="text-xs text-brand-slate/60 text-center mt-4">
