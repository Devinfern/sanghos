...
const AboutHero = ({ isLoaded }: AboutHeroProps) => {
  ...
  return (
    <section className="py-16 md:py-24 px-4 md:px-6 bg-gradient-to-b from-brand-subtle/20 to-white overflow-hidden relative">
      {/* Decorative elements */}
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <Button 
                size="lg" 
                variant="outline" 
                className="border-brand-primary text-brand-primary hover:bg-brand-primary/5 group"
                asChild
              >
                <a href="/join-now">
                  Join Our Community
