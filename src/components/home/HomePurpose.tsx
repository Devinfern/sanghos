...
const HomePurpose = () => {
  ...
  return <section className="py-24 bg-white">
      <div className="container mx-auto px-4 md:px-6">
        <motion.div className="max-w-5xl mx-auto text-center" initial="hidden" whileInView="visible" viewport={{
        once: true
      }} variants={fadeUp}>
          ...
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold text-brand-dark mb-12 leading-tight">We're working to democratize the growing wellness gap</h2>
