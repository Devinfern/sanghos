      ...
      <div className="container relative z-10 mx-auto px-4 md:px-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            duration: 0.6
              ...
              <div className="p-8">
                ...
                <Button variant="outline" className="border-white font-medium group bg-slate-200 hover:bg-slate-100 text-[#4b4b4b]">
                  Learn More
          ...
          <div className="mt-16 text-center">
            <Button size="lg" className="bg-[#D2EF9A] text-brand-dark hover:bg-[#C2E280] group rounded-full" onClick={handleCommunityClick}>
              Join Our Community
              <ArrowRight className="ml-2 h-4 w-4 transition-transform group-hover:translate-x-1" />
            </Button>
          </div>
