...
const HomeHero = () => {
  ...
  return (
    <section className="relative pt-24 pb-32 bg-[#F3F1ED] overflow-hidden">
      ...
      <div className="container relative z-10 mx-auto px-4 md:px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold text-brand-dark leading-[1.1] mb-6">
            ...
            <form onSubmit={handleSearch} className="relative max-w-xl mb-8">
              <div className="flex items-center">
                ...
                <Input 
                  ...
                  className="pl-12 pr-28 py-7 bg-white shadow-md border-none rounded-full text-foreground placeholder:text-muted-foreground/70 focus:outline-none focus:ring-0" 
                  value={query} 
                ...
                <Button 
                  type="submit" 
                  size="lg" 
                  className="absolute right-1.5 h-12 px-6 rounded-full bg-brand-primary hover:bg-brand-primary/90 font-medium"
                >
                  <span>Search</span>
          ...
          >
            <img 
              src="/lovable-uploads/6cfc97b1-427f-4ebf-a716-8fe99ee5694a.png" 
