...
const HomeHero = () => {
  ...
  return <section className="relative pt-24 pb-32 bg-[#F3F1ED] overflow-hidden 100vh">
      ...
      <div className="container relative z-10 mx-auto px-4 md:px-6 py-[24px]">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center my-0 py-[49px]">
          ...
          once: true
            ...
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold text-brand-dark leading-[1.1] mb-6">Wellness Experiences, Tailored To You.</h1>
          ...
          once: true
            ...
            <img alt="Peaceful meditation space with natural light" className="w-full h-full object-cover" src="/lovable-uploads/eb5e3a10-e1d3-49a7-9bd6-f9cfd8a697fc.jpg" />
          </motion.div>
        </div>
      </div>
    </section>;
