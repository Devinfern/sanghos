...
const JoinCommunity = () => {
  ...
  return <section id="join-community" className="py-24 md:py-36 relative overflow-hidden">
      <div className="absolute inset-0 z-0">
        <div className="absolute inset-0 bg-brand-dark/70 z-10"></div>
        <img src="https://images.unsplash.com/photo-1465146344425-f00d5f5c8f07" alt="Peaceful retreat setting" className="w-full h-full object-cover" />
      </div>
      ...
      <div className="container relative z-20 px-4 md:px-6">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-6">
            <Button size="lg" className="bg-brand-primary hover:bg-brand-primary/90" onClick={() => navigate('/retreats')}>
              Browse Retreats
            </Button>
            <Button size="lg" variant="outline" onClick={handleCommunityClick} className="border-white hover:bg-white/10 font-normal text-white\n">
              Join Our Community
            </Button>
          </div>
        </div>
